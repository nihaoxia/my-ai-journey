...
- 页面文件放哪里?  /app
- 组件放哪里？  /components
使用框架  预制的乐高积木 提供了一系列的约束 最佳实践 和 AI SDD  文档上下文不谋而合。

开发效率大大提高，常见功能内置好，文件放在哪里，请求方法放哪？
框架提供基础结构，开发者专注于**业务逻辑**。AI FDE harness 落地
使用框架 也给AI 一套约束 一套上下文  
AI 能够更高效地根据框架给的约束 开发项目
...
- 生态超级丰富
 ...
 - tailwindcss
   ...
   AI 语义 理解能力
 - vercel 公司
   全球几乎唯一一家JS栈  AI coding Agent 以及生态的技术公司
   可以快捷发布  域名二级  绑定域名。
